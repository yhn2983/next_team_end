      ...
      <DefaultLayout pageName="privacyRule">
        ...
        >
          ...
          <div className="col">
            ...
            <p>
              3.於一般瀏覽時，伺服器會自行記錄相關行徑，包括您使用連線設備的 IP
          ...
          <div className="col">
            <p className="fs-5">
              <strong>八、聯繫管道</strong>
            </p>
            <p>
              對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請前往本站「聯絡我們」頁面提交表單。
            </p>
          </div>
          <p className="text-center fs-5">生效日期:2000/1/1</p>
        </div>
      </DefaultLayout>
    </>
  )
